...
temp_image="https://cdn5.vectorstock.com/i/1000x1000/97/84/breaking-news-studio-template-holographic-globe-vector-27279784.jpg"
...
def home(request):
    ...
    for i in data:
        context["data"].append({
            ...
            "url": i["url"],
            "image":  temp_image if i["urlToImage"] is None else i["urlToImage"],
